...
class MazeGenerator:
    ...
    def generate(self, algo: str) -> None:
    ...
    def dfs(
        ...
        while True:
            ...
            if animate:
                self.animate_generation_step(color, delay)

            self.dfs(nx, ny, animate, color, delay)
    ...
    def animate_generation_step(self, color: str, delay: float) -> None:
        """Animate a single maze generation step."""
        print("\033[H\033[J", end="")
        self.display_maze(color)
        time.sleep(delay)
    ...
    def animate_solution_path(
        ...
        for step in path:
            ...
            print("\033[H\033[J", end="")
            self.display_maze(color, animated)
            time.sleep(delay)

    def display_maze(self, color: str,
